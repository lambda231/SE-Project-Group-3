...
<form method = "post">
	...
	Mã máy in: <input type="text" size="6" id="printerID" name="printerID" placeholder="Vd: 1,2,3" pattern = "[0-9,]{0,}" value=<?php if(notempty("printerID", $_POST)) {echo $_POST["printerID"];} ?>><br>
