...
$logs = array(new Log(1, array("log1", "log2")),
 			new Log(2, "log2"),
            new Log(3, "log3"),
			new Log(4, array("log4", "log5")),
 			new Log(5, "log5"),
            new Log(6, "log4"),
			new Log(7, "log3"),
 			new Log(8, "log2"),
            new Log(9, array("log2", "log3")),
			new Log(10, "log1"),
 			new Log(11, "log8"),
            new Log(12, array("log7", "log8")),
 			);
...
<line> 
	<displaybox><img src="icon_view_report.png" width=50 height=50></displaybox>
	<displaybox0><b> CONTENT REVIEW </b></displaybox0>
</line>

<table id="mainTable">
	<tr>
		<th>Month</th>
		<th>Report content in that month</th>
	</tr>
</table>
...
function displayTable(part){
    ...
    switch (j) {
        case 0:
            ...
            break;
        case 1:
			if (Array.isArray(curr.printerID)) {
                cell_text = document.createTextNode(curr.printerID.join(', '));
            } else {
